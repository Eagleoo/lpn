package com.lanpini.lpn_android.widget;
        ...
        close.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (cancelUpdate){
                    ...
                    cancel();
                    dismiss();
                    Util.show(context,context.getResources().getString(R.string.cancel_down));
                }
                else {
                    cancel();
                    dismiss();
...
//                update();
    ...
    private void installApk() {
        ...
        if (Build.VERSION.SDK_INT>=24){
            ...
            Uri apkUri =
                    FileProvider.getUriForFile(context, "com.lanpini.lpn_android.fileprovider", apkfile);
